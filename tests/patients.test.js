...
describe("Patient api tests", () => {
  ...
  it("Can add new patients, cities, symptoms and covid tests", async (done) => {
  ...
  it("Can get all the Patients with their cities name, test results, and symptoms", async (done) => {
    ...
    it('Can get all patients with covid Tests that are positive', async (done) => {
      const { body } = await request(app).get('/api/v1/patients/positive');
      expect(body.length).toBe(3);
      done()
    });

  it("Can get patient by id with his city, test result and symptoms", async (done) => {
  ...
  it("Can get patient by name with his city, test result and symptoms", async (done) => {
  ...
  it("POST a new patient with new CovidTests and thier new symptom", async (done) => {
  ...
  it("Can delete a patient by id", async (done) => {
